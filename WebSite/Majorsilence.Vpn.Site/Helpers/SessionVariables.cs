...
public class SessionVariables : ISessionVariables
{
    ...
    public bool LoggedIn
    {
        get
        {
            if (context.Session.GetString("LoggedIn") == null) return false;
            return Convert.ToBoolean(context.Session.GetString("LoggedIn"));
        }
        set => context.Session.SetString("LoggedIn", value.ToString());
    }
    ...
    public string Username
    {
        get
        {
            ...
            if (context.Session.GetString("Username") == null) return "";
            return context.Session.GetString("Username");
        }
        set => context.Session.SetString("Username", value);
    }
    ...
    public int UserId
    {
        get
        {
            if (context.Session.GetString("UserId") == null) return -1;
            return Convert.ToInt32(context.Session.GetString("UserId"));
        }
        set => context.Session.SetString("UserId", value.ToString());
    }
    ...
    public bool IsAdmin
    {
        get
        {
            if (context.Session.GetString("IsAdmin") == null) return false;
            return Convert.ToBoolean(context.Session.GetString("IsAdmin"));
        }
        set => context.Session.SetString("IsAdmin", value.ToString());
    }
}