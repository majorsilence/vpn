...
namespace Majorsilence.Vpn.Logic.Accounts
{
    public class UserServerDetails
    {
        ...
        public UserServerDetails(int userId)
        {
            ...
            sql.Append("select a.Id as 'VpnServerId', b.Id as 'RegionId', a.Description as 'VpnServerName', b.Description as 'RegionName', a.Address, '' as 'Password'");
            ...
            using (var db = InitializeSettings.DbFactory)
            {
                ...
                {
                    throw new Exceptions.InvalidDataException("Some how you have multiple vpn certs and that is not supposed to be possible yet.");
                }
                ...
                {
                    throw new Exceptions.InvalidDataException("Some how you have multiple pptp accounts or vpn certs and that is not supposed to be possible yet.");
                }
        ...
        public UserServerDetailsInfo Info
        {
            get
            {
                return details;
