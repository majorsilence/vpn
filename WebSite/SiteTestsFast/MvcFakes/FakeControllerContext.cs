...
namespace MvcFakes
{
    ...
    public class FakeControllerContext : ControllerContext
    {
        ...
        (
            ...
            : this(controller, userName, roles, formParams, queryStringParams, cookies, sessionItems, null)
        {
        }
        ...
        public FakeControllerContext
            ...
            : base(
                new FakeHttpContext(
                    new FakePrincipal(new FakeIdentity(userName), roles), formParams, queryStringParams, cookies, sessionItems, headers), 
                new RouteData(), 
                controller
            )
        {
